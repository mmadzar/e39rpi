...
monitorCommands = [
      ...
      { name: 'driver_front_window_open', hexId: '3F 05 00 0C 52 01'.split(' '), intId: [], description: 'Driver Front Window Open' },
      { name: 'driver_rear_window_open', hexId: '3F 05 00 0C 41 01'.split(' '), intId: [], description: 'Driver Rear Window Open' },
      { name: 'passenger_front_window_open', hexId: '3F 05 00 0C 54 01'.split(' '), intId: [], description: 'Passenger Front Window Open' },
      { name: 'passenger_rear_window_open', hexId: '3F 05 00 0C 00 47'.split(' '), intId: [], description: 'Passenger Rear Window Open' },
      { name: 'driver_front_window_close', hexId: '3F 05 00 0C 53 01'.split(' '), intId: [], description: 'Driver Front Window Close' },
      { name: 'driver_rear_window_close', hexId: '3F 05 00 0C 00 44'.split(' '), intId: [], description: 'Driver Rear Window Close' },
      { name: 'passenger_front_window_close', hexId: '3F 05 00 0C 00 55'.split(' '), intId: [], description: 'Passenger Front Window Close' },
